...
const industries = [
  ...
  { id: 'hospitality', name: 'Hospitality', icon: '🏨', color: 'bg-indigo-100' }
];
    ...
    <div className="max-w-5xl mx-auto">
      <section className="text-center mb-12">
        ...
        <p className="text-xl text-gray-600 mb-6">
          Professional templates for any business or platform. Customize, edit, and download in minutes.
        </p>
      </section>
            ...
            >
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Browse {industry.name} templates</p>
                </div>
              </div>
            </Link>
          ))}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          >
            ...
            <div className="p-4">
              ...
              <p className="text-gray-600 text-sm">Professional business card template</p>
            </div>
          </Link>
          <Link 
            to="/editor/invoice" 
          ...
          >
            ...
            <div className="p-4">
              ...
              <p className="text-gray-600 text-sm">Clean and professional invoice layout</p>
            </div>
          </Link>
          <Link 
          ...
          >
            ...
            <div className="p-4">
              ...
              <p className="text-gray-600 text-sm">Engaging social media template</p>
            </div>
          </Link>
        </div>
      </section>
